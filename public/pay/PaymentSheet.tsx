...
export default function PaymentSheet({
  ...
  async function handleSend() {
    ...
    try {
      ...
      // Supplementary on-chain receipt log — fired after the real payment has
      // already settled via UA. Deliberately not awaited/blocking: this never
      // affects whether the payment itself is shown as successful, and
      // logPaymentReceipt() internally swallows its own errors.
